...
// Comenzamos por definir cada clase que será recurso compartido y por cada lugar (3 en caso de la mesa) se creará un semáforo, con la intencion de implementar un apagador. En este caso no se usa prioidad.
